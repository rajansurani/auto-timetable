import { deleteBatchByName, fetchBatches, updateBatchByName } from "../../../database/dataAccess";
...
function Batches(){
	...
	const handleBatchDelete = () => {
		deleteBatchByName(selectedBatch.batchName).then(() => {
			updateBatchList();
    ...
    return(
        <div>
			...
			<Modal show={showDeleteDialog} onHide={handleCloseDeleteDialog}>
				...
				<Modal.Body>
					You are about to delete {selectedBatch.batchName}.
				</Modal.Body>
				<Modal.Footer>
