import { deleteClassroomByName, fetchClassrooms, updateClassroomByName } from "../../../database/dataAccess";
...
function Classrooms(){
	...
	const handleClassroomDelete = () => {
		deleteClassroomByName(selectedClassroom.classroomName).then(() => {
			updateClassroomList();
    ...
    return(
        <div>
						...
						<Card>
							<Card.Header className="d-flex justify-content-between">
								<div className="header-title">
									<h4 className="card-title">Classrooms</h4>
								</div>
			...
			<Modal show={showDeleteDialog} onHide={handleCloseDeleteDialog}>
				...
				<Modal.Body>
					You are about to delete {selectedClassroom.classroomName}.
				</Modal.Body>
				<Modal.Footer>
					<Button variant="secondary" onClick={handleCloseDeleteDialog}>
						Close
					</Button>
					<Button variant="primary" onClick={handleClassroomDelete}>
						Save Changes
					</Button>
				</Modal.Footer>
			</Modal>
