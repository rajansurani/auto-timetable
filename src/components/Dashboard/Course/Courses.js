...
import { deleteCourseByCode, fetchCourses, updateCourseByCode } from "../../../database/dataAccess";
...
function Courses(){
	...
	const handleCourseDelete = () => {
		deleteCourseByCode(selectedCourse.courseCode).then(() => {
			updateCourseList();
    ...
    return(
        <div>
										...
										<tbody>
											{courseList.map((item, idx) => (
												<tr key={idx}>
													...
													<td>{item.theorySession}</td>
													<td>{item.practicalSession}</td>
													<td>
			...
			<Modal show={showDeleteDialog} onHide={handleCloseDeleteDialog}>
				...
				<Modal.Body>
					You are about to delete {selectedCourse.courseName}.
				</Modal.Body>
				<Modal.Footer>
